...
type IDbConnection with
    ...
    member this.InsertIgnoreAsync<'a> (q:InsertQuery<'a>, ?trans:IDbTransaction, ?timeout:int, ?logFunction, ?cancellationToken : CancellationToken) =
        q |> Deconstructor.insertIgnore<'a> |> IDbConnection.execute this trans timeout cancellationToken logFunction
